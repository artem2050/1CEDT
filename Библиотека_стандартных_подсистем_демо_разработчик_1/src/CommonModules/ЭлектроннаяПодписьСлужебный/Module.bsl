...
Функция ФорматированнаяСтрока(Строка)
	...
	Возврат Новый ФорматированнаяСтрока(СтрокаПреобразованная); // АПК:1356 - можно использовать составную форматированную строку, так как массив строк формируется из переданного в функцию текста.
