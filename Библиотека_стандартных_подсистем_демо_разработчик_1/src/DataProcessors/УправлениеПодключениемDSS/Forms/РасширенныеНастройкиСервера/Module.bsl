...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СервисКриптографииDSSКлиентСервер.ПолучитьПредставлениеСпособовАвторизации(ПервичнаяАвторизация);
	СервисКриптографииDSSКлиентСервер.ПолучитьПредставлениеСпособовАвторизации(ВторичнаяАвторизация);
